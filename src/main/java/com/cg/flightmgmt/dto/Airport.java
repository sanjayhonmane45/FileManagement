...
public class Airport {
	...
	*/
	...
	/*@Size annotation is used to restrict the filed length to a specified value. It has attributes such as max and min which 
	 *are used to set the maximum and minimum values respectively. The message attribute in this annotation is used to 
	 *display a default message on validation failure.
	*/
